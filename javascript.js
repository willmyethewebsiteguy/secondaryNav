...
aria-describedby="desc" role="img" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  stroke-width="2" stroke-linejoin="round"></path>
            ...
            x: {
              html: `<svg viewBox="0 0 24 24" aria-hidden="true"><g><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"></path></g></svg>`
            },
            search: {
              html: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" aria-labelledby="title"
aria-describedby="desc" role="img" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  if (document.querySelectorAll('[data-wm-plugin="subnav"]').length !== 0){
    if (document.querySelectorAll('head link[href*="WMSecondNav92220v2"]').length == 0){
      ...
      link.rel = 'stylesheet';
      link.type = 'text/css';
      link.href = 'https://cdn.jsdelivr.net/gh/willmyethewebsiteguy/secondaryNav@2/styles.min.css';
